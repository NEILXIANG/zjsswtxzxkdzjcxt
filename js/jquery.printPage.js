...
(function ($) {
    $.fn.printPage = function (options) {
        ...
        function unloadMessage() {
            $("#printMessageBox").delay(1000).animate({opacity:0}, 500, function () {
                $(this).remove();
            });
        }
